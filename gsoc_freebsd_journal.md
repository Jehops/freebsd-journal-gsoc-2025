...
The _Testing and Development for Rust FreeBSD Device Drivers_ project builds on past efforts to incorporate Rust into FreeBSD development.  One of its primary goals was to create a testing and continuous-integration framework for Rust kernel modules.  Aaron gives an overview of his Rust echo driver in this [video](https://www.youtube.com/watch?v=y82-t1tDLWg) and summarizes the project in this [writeup](https://gist.github.com/Acesp25/8928e35e710fdce1896b5448fc6327df).  His code is available here:
